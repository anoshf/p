# Anosh Fallah — AI Cloud & Software Architect

A single-page React site targeted at **AI Cloud & Software Architect** roles. No backend, no database, no
...
```bash
git add .
git commit -m "Update anjquy content"
git push
```
...
```
https://YOUR-USERNAME.github.io/anjquy/
```
...
```yaml
seo:
  siteUrl: "https://YOUR-USERNAME.github.io/anjquy"
```
