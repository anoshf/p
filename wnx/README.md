# Anosh Fallah — Full-Stack Web Developer

A single-page React site targeted at **Full-Stack Web Developer** roles. No backend, no database, no
...
```bash
git add .
git commit -m "Update wnx content"
git push
```
...
```
https://YOUR-USERNAME.github.io/wnx/
```
...
```yaml
seo:
  siteUrl: "https://YOUR-USERNAME.github.io/wnx"
```
