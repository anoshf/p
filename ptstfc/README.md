# Anosh Fallah — AI Platform Engineer

A single-page React site targeted at **AI Platform Engineer** roles. No backend, no database, no
...
```bash
git add .
git commit -m "Update ptstfc content"
git push
```
...
```
https://YOUR-USERNAME.github.io/ptstfc/
```
...
```yaml
seo:
  siteUrl: "https://YOUR-USERNAME.github.io/ptstfc"
```
